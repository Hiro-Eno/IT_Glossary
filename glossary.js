...
{target:`エミュレーター`, content:`特定の環境で動作するソフトウェアを、異なる環境で疑似的に動作させる手法。ふるいかんきょうでつかっていたそふとうぇあをあたらしいかんきょうでうごかすためにつかわれることがおおい。`},
{target:`スケーラビリティ`, content:`負荷に応じてシステムを拡張。ハードウェアやソフトウェアなどを次男に拡張できること。`},
