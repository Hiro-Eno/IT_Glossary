...
{target:`KPIとKGI（Key PerformanceIndicator, KeyGoal Indicator）`, content:`企業や部署における目標達成の指標。前者は、重要業績評価指標でページビューやコンバージョン率などの数値目標を指す。後者は、重要目標達成指標で売上高や利益率などの目標を指す。`},
